    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', '在校新生'), ('admin', '系统管理员')], default='student', max_length=10, verbose_name='用户角色')),
                ...
                ('major', models.CharField(blank=True, max_length=50, null=True, verbose_name='所属专业')),
